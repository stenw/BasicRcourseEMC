...
In this practical, you will gradually build a small working script. Try to keep all commands in a single script file instead of typing everything only in the console.
...
After you run each line, pause briefly and check whether the answer matches what you expected.
:::
