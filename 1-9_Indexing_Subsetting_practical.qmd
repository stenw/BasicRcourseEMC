...
Try to keep your work in a single script. For each task, it is useful to ask yourself two questions:

1. What kind of object will this code return?
2. Why is this subset scientifically or practically interesting?
...
::: callout-tip
When you subset an object, do not only look at the values that come back. Also check the class of the result when that is not obvious.
:::
...
- If you have time, also select the first and second row of the second column.
:::
