...
As shown above we usually use two indices to select elements in a matrix. However, there it is also possible to use a single index. In this case R treats the matrix as a vector by stacking the columns on top of each other.
