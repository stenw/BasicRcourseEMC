...
This first step is important because it separates the clinical calculation from the Shiny machinery. Once the calculation works outside the app, it is much easier to place it inside the app.
:::
