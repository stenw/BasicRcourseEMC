...
Base **R** has many fuctions but many more are come from various extension packages. These can be installed using `install.packages()` :
...
-   Google. And when you're actually **online**, often the **first** place and \*\*last\*\* place you'll go when you have no idea is [Google (https://www.google.com)](https://www.google.com).
